...
class MahasiswaController extends Controller
{
    ...
    {
        //akses table prodi untuk menampilkan pilihan prodi di form
        $prodi = Prodi::all();
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('foto')){
            ...
            $nama_foto = time() . '_' . $foto->getClientOriginalName(); //buat nama unik dari foto
            $foto->storeAs('fotos', $nama_foto, 'public'); //simpan foto di folder storage/app/fotos
        } else {
            $nama_foto = null; // jika tidak ada foto, tambahkan nama_foto ke null
        }
